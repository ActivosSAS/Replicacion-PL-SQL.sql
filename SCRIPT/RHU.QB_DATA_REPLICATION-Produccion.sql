...
Insert into USUARIOS_DOMINIO (UDS_ID,ROD_ID,USU_USUARIO,UDS_ESTADO,AUD_FECHA,AUD_USUARIO) 
values ((select MAX(UDS_ID)+1 from usuarios_dominio),9,'CARPAEZ','S',SYSDATE,'DESIERRA');

Insert into USUARIOS_DOMINIO (UDS_ID,ROD_ID,USU_USUARIO,UDS_ESTADO,AUD_FECHA,AUD_USUARIO) 
values ((select MAX(UDS_ID)+1 from usuarios_dominio),144,'CARPAEZ','S',SYSDATE,'DESIERRA');
...
Insert into USUARIOS_DOMINIO (UDS_ID,ROD_ID,USU_USUARIO,UDS_ESTADO,AUD_FECHA,AUD_USUARIO) 
values ((select MAX(UDS_ID)+1 from usuarios_dominio),40,UPPER('ddavinci'),'S',SYSDATE,'DESIERRA');
/
...
BEGIN
    ...
    INSERT ALL
        ...
        VALUES (v_max_id + 1, 9, 'JOCOLMENARES', 'S', SYSDATE, 'DESIERRA');
