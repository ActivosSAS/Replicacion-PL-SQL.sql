create or replace PACKAGE BODY                                 SEL.QB_APLICATION_JSEL0029 as
  ...
  */
    ...
    BEGIN
      PB_SEGUIMIENTO_LONG(
        'REPLICACION',  
        'Procedimiento: guardadatosbasicos, ' ||
        'vceplnom1: ' || vceplnom1 || ', ' ||
...
--      END IF;
      ...
      END IF;
        ...
        --****************************************************************
        --** OBJETIVO              :    Solo se inserta si la fuente es 'COMPUTRABAJO_MASIVO'y vcedfciunombreteletiqueta no es NULL.
        --**                            Para el Envio de Correo Masivo en la Noche.        
        --** TABLA                 :    RHU.CANDIDATE_BULK_UPLOAD
        --** AUTOR                 :    JUFORERO
